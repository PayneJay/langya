...
public class CircleLoadingView extends View {
    ...
    public CircleLoadingView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        try {
            ...
            mCircleRadius = typedArray.getDimensionPixelSize(R.styleable.CircleLoadingView_cl_circleRadius, -1);
            mAnimationDuration = typedArray.getFloat(R.styleable.CircleLoadingView_cl_fillAnimationDuration, 800);
            mCircleStrokeSize = typedArray.getDimensionPixelSize(R.styleable.CircleLoadingView_cl_circleStrokeSize, -1);
